...
const GradualBlur = forwardRef(function GradualBlur(props, ref) {
  const containerRef = useRef(null)
  const [isHovered, setIsHovered] = useState(false)

  // Forward the ref so callers can drive the container's opacity imperatively
  // (App.jsx writes the movies-transition fade straight to the DOM — no React
